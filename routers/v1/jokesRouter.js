...
export default class JokeRoutes{
    ...
    routes(){
         ...
         *     produces:
         *       - application/json
         *     description: Returns all jokes
         *     summary: List all the jokes
         *     parameters:
         *       - in: query
         *         name: token
         *         required: true
         ...
         *     produces:
         *       - application/json
         *     description: Returns a specific joke
         *     summary: Find a specific joke
         *     parameters:
         *       - in: query
         *         name: token
         *         required: true
         ...
         *         schema:
         *           type: string
         *           example: e7ca8070-155d-11e8-bbf2-4d88bb142dc5
         *     responses:
         *       200:
         *         description: Success
         */
         ...
         *     produces:
         *       - application/json
         *     description: Update a specific joke
         ...
         *              sentence:
         *                  type: string
         *                  example: Tell me something so funny
         *              tags:
         *                  type: string
         *                  example: 1
         *     responses:
         ...
         *     produces:
         *       - application/json
         *     description: Remove a joke
         *     summary: Remove a joke
         *     parameters:
         *       - in: path
         *         name: jokeId
         *         required: true
